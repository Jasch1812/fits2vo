...
class Table(Element, _IDProperty, _NameProperty, _UcdProperty,
    ...
    def __init__(self, votable, ID=None, name=None, ref=None, ucd=None,
        ...
        self._ref = ref
        # To connect to fits file
        self.href = None #---- J. Schoeleinder 2017.08.02
        self.ucd = ucd
        self.utype = utype
    ...
    def format(self, format):
        ...
        elif format not in ('tabledata', 'binary', 'fits'):# ---- J. Schoeleinder 2017.08.02
    ...
    def to_xml(self, w, **kwargs):
        ...
        if specified_format is not None:
            ...
            format = self.format
        # if format == 'fits':
            # format = 'tabledata' #---- J. Schoeleinder 2017.08.02
    ...
    def set_href(self, fits_path):
        # ---- J. Schoeleinder 2017.08.02
        if not fits_path.startswith(('http', 'ftp', 'file')):
            vo_raise(
                "The vo package only supports remote data through http, "
    ...
    def _write_fits(self, w, **kwargs):
        ...
        # ---- J. Schoeleinder 2017.08.02
        with w.tag('FITS'):
            with w.tag('STREAM', href=self._href):
                w._flush()
